...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/empty-sound-0c01)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-sound-0c01
```

A live public deployment of this template is available at [https://empty-sound-0c01.templates.workers.dev](https://empty-sound-0c01.templates.workers.dev)
